...
class DrivableMap {
    ...
    /* TO.DO Task finished: Write a method named addDrivable that takes a String (the ID)
    ...
    /* TO.DO Task finished: Write a method named hasFasterThan that takes an int (a speed)
    ...
    /* TO.DO Task finished: Write a method named getTradable that takes no arguments and
